...
use BitPagos\Validation\JsonValidator;
use BitPagos\Validation\ModelAccessorValidator;
...
class BitPagosModel
{
	 ...
	 *
	 * @var \BitPagos\Auth\OAuthTokenCredential $credential
	 */
