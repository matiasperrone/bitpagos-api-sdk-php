...
/**
 * Class BitPagosUserAgent
 * BitPagosUserAgent generates User Agent for curl requests
 *
...
class BitPagosUserAgent
{
    ...
    public static function getValue($sdkName, $sdkVersion)
    {
        ...
        return sprintf("BitPagosSDK/%s %s (%s)", $sdkName, $sdkVersion, implode(';', $featureList));
    }
